# Production MT host: sync per-caller tokens (runtime file is .env.staging on Windows).
param(
    [string]$InstallRoot = "C:\esafx\mt-bridge-service",
    [string]$Region = "ap-southeast-3",
    [string]$TokensSecretId = "esafx/production/service-tokens",
    [string]$WebhookSecretId = "esafx/production/mt-bridge-webhook",
